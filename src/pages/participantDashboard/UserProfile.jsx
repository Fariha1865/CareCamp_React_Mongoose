                            ...
                            <div className="flex justify-around items-start">
                                ...
                                <div>
                                    <div className="flex items-center mb-5">
                                        <label className=" font-bold"> Registered Camps:</label>
                                ...
                                <div>
                                    <div className="flex items-center mb-5">
                                        <label className="font-bold">Attended Camps:</label>
                                        {/* <span className="text-blue-700 font-semibold ml-5">{user?.attendedCamps}</span> */}
                                    </div>
                                    <div className="flex items-center">
                                        <label className="font-bold">Interests in Medical Areas:</label>
                                        {/* <ul className="list-disc pl-6">
                    {user?.medicalInterests.map((interest, index) => (
                        <li key={index} className="text-blue-700 font-semibold ml-5">{interest}</li>
                    ))}
                </ul> */}
