...
const ProfessionalProfile = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto">
                            ...
                            <div className="flex justify-around items-start">
                                ...
                                <div>
                                    <div className="flex items-center mb-5">
                                        <label className=" font-bold"> Accepted Camps:</label>
                                ...
                                <div>
                                    <div className="flex items-center mb-5">
                                        ...
                                        <span className="text-blue-700 font-semibold ml-5">{userData[0]?.specialty}</span>
                                    </div>
                                    <div className="flex items-center mt-5">
                                    ...
                                    <div className="flex items-center mt-5">
                                        ...
                                        <span className="text-blue-700 font-semibold ml-5">{userData[0]?.certification}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <Button gradientDuoTone="greenToBlue" className="top-24 left-12 " onClick={() => setOpenModal(true)}>Edit Profile</Button>
