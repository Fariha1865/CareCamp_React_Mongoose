...
const UpcomingCampDetails = () => {
    ...
    const handleSubmit = e => {
        ...
        axiosSecureCalls.post("/growingParticipants", registeredParticipant)
            .then(result => {
                console.log(result)
            })
        setOpenModal(false);
    ...
    const handleInterested = e => {
        ...
        axiosSecureCalls.post("/interestedProfessionals", interestedProfessionals)
            .then(result => {
                console.log(result)
            })
        setOpenModal2(false);
    ...
    return (
        <div className="max-w-6xl mx-auto pt-24">
                                ...
                                <div className="flex flex-col gap-3 border-blue-300 border-solid border-2 py-20 px-3">
...

                                    {
                                        userData[0]?.role === "Participant" ?
                                            <Button onClick={() => setOpenModal2(true)} gradientDuoTone="greenToBlue" className="mt-4">Join This Camp</Button>

                                            :
                                            userData[0]?.role === "Healthcare Professional" ?
                                                <Button onClick={() => setOpenModal2(true)} gradientDuoTone="greenToBlue" className="mt-4">Interested Upcoming</Button>
                                                :
                                                ""
                                    }
            ...
            <Modal show={openModal2} size="md" onClose={onCloseModal2} popup>
                <Modal.Header />
                <h1 className="text-center font-bold mb-5 text-blue-700">Register to join {camp?.CampName} !</h1>
                <Modal.Body>
                    <div className="">
                        <form className="h-[600px]" onSubmit={handleInterested}>
                            <div className="flex flex-col gap-4 p-6">
                                <div className="flex gap-5">
                                    <div className="relative h-11 ">
                                        <input type="name" name="name" required
                                ...
                                <div>
                                    <label htmlFor="message">Enter Specializations*:</label>
                                    <textarea
                                        id="specialization"
                                        name="specialization"
                                        rows={2} // Set the number of rows you want
                                        cols={32} // Set the number of columns you want
                                        placeholder="Enter your specializations  here"
                                        required
                                    />
                                </div>
                                <div>
                                    <label htmlFor="message">Area of Interests:</label>
                                    <textarea
                                        id="areaInterest"
                                        name="areaInterest"
                                        rows={2}
                                        cols={34}
                                        placeholder="Radiology,Neurosurgery, Cardiology etc"
                                    />
                                </div>
                            ...
                            <div className="p-0">
                                <input type="submit" value="Show Interest In Camp" className="block w-full select-none rounded-lg bg-blue-900 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                />
